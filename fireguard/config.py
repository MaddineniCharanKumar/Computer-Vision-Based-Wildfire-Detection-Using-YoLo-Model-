...
class Settings(BaseSettings):
    ...
    environment_provider:str="open_meteo"; weather_api_url:str="https://api.open-meteo.com/v1/forecast"; air_quality_api_url:str="https://air-quality-api.open-meteo.com/v1/air-quality"; weather_api_key:str|None=None; environment_max_age_seconds:int=300; environment_timeout_seconds:float=10.0
    alert_cooldown_seconds:int=60; upload_max_mb:int=100; camera_url:str|None=None; camera_id:str="default-camera"
    firms_map_key:str|None=None; firms_source:str="VIIRS_NOAA21_NRT"; firms_region:str="world"; firms_days:int=1; satellite_provider:str="firms"
